...
- 3 paket utama dalam card yang eye-catching:
  ...
  - **Growth** - Rp 2.750.000
  - **Ultimate** - Rp 3.750.000
- Fitur-fitur utama di setiap card
...
- Tab atau accordion untuk setiap kategori:
  ...
  - Website UMKM (Starter/Business/Pro)
  - Toko Online (Starter/Business/Pro)
  - Custom System (Starter/Business/Pro)
- Detail lengkap fitur sesuai data yang diberikan
...
- Setiap card menampilkan:
  ...
  - Kategori (Landing Page, Company Profile, dll)
...
- Kategori paket yang cocok
- Tombol CTA WhatsApp untuk konsultasi/order
